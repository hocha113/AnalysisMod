...
{
    public class AnalysisChest : ModTile
    {
		...
		public override IEnumerable<Item> GetItemDrops(int i, int j) {
			...
			if (style == 0) {
				yield return new Item(ModContent.ItemType<Items.Placeable.Furniture.AnalysisChest>());
			}
			if (style == 1) {
				yield return new Item(ModContent.ItemType<Items.Placeable.Furniture.AnalysisChest>());
			}
		...
		*/
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            else
            {
                ...
                {
                    player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.AnalysisChest>();
                    if (Main.tile[left, top].TileFrameX / 36 == 1)
                    {
                        player.cursorItemIconID = ModContent.ItemType<AnalysisChestKey>();
                    }
